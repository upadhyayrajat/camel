...
public class HttpEndpoint extends ScheduledPollEndpoint {
    ...
    @Deprecated
    public HttpEndpoint(String uri, CamelContext context, S3Configuration configuration) {
        super(uri, context);
        this.configuration = configuration;
    }

    public HttpEndpoint(String uri, Component comp, S3Configuration configuration) {
        super(uri, comp);
        this.configuration = configuration;
    }
    ...
    public void doStart() throws Exception {
        ...
        if (ObjectHelper.isNotEmpty(configuration.getAmazonHttpEndpoint())) {
            s3Client.setEndpoint(configuration.getAmazonHttpEndpoint());
        }
